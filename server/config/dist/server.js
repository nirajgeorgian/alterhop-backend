...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "b80b990873a6da710752";
...
/* harmony import */ var _resources_user_user_resolver_query__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./resources/user/user.resolver.query */ "./src/resources/user/user.resolver.query.js");
...
var server = http__WEBPACK_IMPORTED_MODULE_1___default.a.createServer(_server__WEBPACK_IMPORTED_MODULE_2__["default"]);
var currentApp = _server__WEBPACK_IMPORTED_MODULE_2__["default"];

_server__WEBPACK_IMPORTED_MODULE_2__["GraphQLEngine"].listen({
  port: port,
  httpServer: server,
  logging: {
...
console.log('\uD83D\uDE80 Server ready at http://localhost:' + port + _server__WEBPACK_IMPORTED_MODULE_2__["GraphQLServer"].graphqlPath);
...
var UserGraphqlSchema = "\n\ttype SocialUrls {\n\t\tfacebook: String\n\t\tgoogle: String\n\t\ttwitter: String\n\t\tgithub: String\n\t\tinstagram: String\n\t\tpersonal: String\n\t}\n\ttype Status {\n\t\tstatus: Boolean!\n\t}\n\ttype Notification {\n\t\tjob_posting: Status!\n\t\tcompany_promotion: Status!\n\t\tmessage: Status!\n\t\tmail: Status!\n\t\tcomment: Status!\n\t}\n\tenum SubscriptionTypeEnum {\n\t\tfree\n\t\tstarter\n\t\tpremium\n\t}\n\tenum AccountTypeEnum {\n\t\tprovider\n\t\tseeker\n\t}\n\ttype Account {\n\t\taccount_type: AccountTypeEnum!\n\t\tsubscription_type: SubscriptionTypeEnum!\n\t}\n\ttype User {\n\t\tid: ID!\n\t\tusername: String!\n\t\temail: String!\n\t\tphone: String\n\t\taddress: String\n\t\tlocation: String\n\t\tprofile_picture: String\n\t\tverified: Boolean!\n\t\tcreated_at: String!\n\t\tupdated_at: String!\n\t\tsocial_urls: SocialUrls!\n\t\tnotification: Notification!\n\t\taccount: Account!\n\t}\n\ttype UserResult {\n\t\tstatus: Boolean!\n\t\tmessage: String!\n\t\tuser: User\n\t}\n\ttype Result {\n\t\tstatus: Boolean!\n\t\tmessage: String!\n\t}\n\ttype PasswordReset {\n\t\ttoken: String\n\t\tconfirm: Boolean\n\t}\n\textend type Query {\n\t\tcurrentUser: User\n\t\tgetMe: String\n\t\tcheckEmail(email: String!): Result!\n\t\tcheckUser(username: String!): Result!\n\t\tgetAllUser: [User]!\n\t\tgetUser(id: ID!): User\n\t\tnotification(id: ID!): Notification\n\t}\n\tinput AccountTypeInput {\n\t\taccount_type: AccountTypeEnum!\n\t\tsubscription_type: SubscriptionTypeEnum\n\t}\n\tinput UserSignupCred {\n\t\tusername: String!\n\t\temail: String!\n\t\tpassword: String!\n\t\taccount: AccountTypeInput!\n\t}\n\tinput UserLoginCred {\n\t\tusername: String\n\t\temail: String\n\t\tpassword: String!\n\t}\n\tinput UserCheck {\n\t\temail: String\n\t\tusername: String\n\t}\n\tinput Token {\n\t\ttoken: String!\n\t\temail: String\n\t\tusername: String\n\t}\n\tinput ResetPassword {\n\t\ttoken: String!\n\t\temail: String\n\t\tusername: String\n\t\tpassword: String!\n\t\tagainPassword: String!\n\t}\n\textend type Mutation {\n\t\tsignup(input: UserSignupCred!): UserResult!\n\t\tlogin(input: UserLoginCred!): Result!\n\t\tpasswordToken(input: UserCheck!): Result!\n\t\tconfirmToken(input: Token!): Result!\n\t\tresetPassword(input: ResetPassword!): Result!\n\t\tchangeUsername(input: UserCheck!): Result!\n\t}\n";
...
/* harmony import */ var babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babel-runtime/helpers/asyncToGenerator */ "babel-runtime/helpers/asyncToGenerator");
/* harmony import */ var babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _user_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user.model */ "./src/resources/user/user.model.js");
/* harmony import */ var _utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/resuleGenerate */ "./src/resources/utils/resuleGenerate.js");
/* harmony import */ var _utils_resultUser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/resultUser */ "./src/resources/utils/resultUser.js");
/* harmony import */ var _utils_jwt_auth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/jwt.auth */ "./src/resources/utils/jwt.auth.js");
		...
		return babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						_context.next = 2;
						return _user_model__WEBPACK_IMPORTED_MODULE_2__["User"].findOne({ $or: [{ email: input.email }, { username: input.username }] });
					...
					case 2:
						...
						return _context.abrupt("return", Object(_utils_resultUser__WEBPACK_IMPORTED_MODULE_4__["generateUser"])(false, "Email or Username is already taken"));

					case 5:
						user = new _user_model__WEBPACK_IMPORTED_MODULE_2__["User"](input);
					...
					case 9:
						...
						return _context.abrupt("return", Object(_utils_resultUser__WEBPACK_IMPORTED_MODULE_4__["generateUser"])(true, "successfully created user", newUser));
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					...
					case 2:
						...
						return _context2.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "No user exist with this username or email address"));
					...
					case 5:
						...
						return _context2.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Password Wrong."));

					case 8:
						payload = { id: user.id, email: user.email, username: user.username, account_type: user.account.account_type };
						token = "Bearer " + Object(_utils_jwt_auth__WEBPACK_IMPORTED_MODULE_5__["generateJwtToken"])(payload);
						return _context2.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, token));
			...
			while (1) {
				switch (_context3.prev = _context3.next) {
					case 0:
						...
						_context3.next = 4;
						return _user_model__WEBPACK_IMPORTED_MODULE_2__["User"].findOne({ $or: [{ email: email }, { username: username }] });
					...
					case 4:
						...
						return _context3.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass email or username"));
					...
					case 8:
						...
						return _context3.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "no user exist for this " + email));
					...
					case 12:
						token = Object(_utils_tokenGenerate__WEBPACK_IMPORTED_MODULE_6__["generateToken"])(50);

						if (email !== '') {
							redisClient.set(email + "-password-reset", token, redis__WEBPACK_IMPORTED_MODULE_7___default.a.print);
						}
						if (username !== '') {
							redisClient.set(username + "-password-reset", token, redis__WEBPACK_IMPORTED_MODULE_7___default.a.print);
						}
						return _context3.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, token));
			...
			while (1) {
				switch (_context4.prev = _context4.next) {
					case 0:
						...
						isKey = redisClient.get(key, redis__WEBPACK_IMPORTED_MODULE_7___default.a.print);
						...
						return _context4.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "no value for provider key"));
					...
					case 12:
						...
						return _context4.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass email or username"));
					...
					case 16:
						...
						return _context4.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "no user exist for this " + email));
					...
					case 22:
						...
						return _context4.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass valid token"));

					case 25:
						// data is equal to token
						redisClient.del(key);
						newToken = Object(_utils_tokenGenerate__WEBPACK_IMPORTED_MODULE_6__["generateToken"])(50);

						if (email !== '') {
							redisClient.set(email + "-password-token", newToken, redis__WEBPACK_IMPORTED_MODULE_7___default.a.print);
						}
						if (username !== '') {
							redisClient.set(username + "-password-token", newToken, redis__WEBPACK_IMPORTED_MODULE_7___default.a.print);
						}
						return _context4.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, newToken));
			...
			while (1) {
				switch (_context5.prev = _context5.next) {
					...
					case 8:
						...
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass email or username"));
					...
					case 12:
						...
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "no user exist for this " + email));
					...
					case 14:
						...
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "no user exist for this " + username));
					...
					case 18:
						...
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass valid token"));
					...
					case 21:
						...
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Wrong password match."));
					...
					case 27:
						redisClient.del(key);
						return _context5.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, "Successfully updated the password"));
			...
			while (1) {
				switch (_context6.prev = _context6.next) {
					...
					case 2:
						...
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "Please pass email or username"));
					...
					case 8:
						...
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, "You updated your own email"));

					case 13:
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "user exist for this " + email));
					...
					case 14:
						...
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, "You updated your own username"));

					case 17:
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(false, "user exist for this " + username));
					...
					case 18:
						...
						_context6.next = 21;
						return _user_model__WEBPACK_IMPORTED_MODULE_2__["User"].findOne({ email: user.email });
					...
					case 25:
						...
						_context6.next = 28;
						return _user_model__WEBPACK_IMPORTED_MODULE_2__["User"].findOne({ username: user.username });
					...
					case 32:
						return _context6.abrupt("return", Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_3__["generateResult"])(true, "Successfully updated"));
...
/* harmony import */ var _utils_tokenGenerate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/tokenGenerate */ "./src/resources/utils/tokenGenerate.js");
/* harmony import */ var _utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/resuleGenerate */ "./src/resources/utils/resuleGenerate.js");
/* harmony import */ var _utils_helper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/helper */ "./src/resources/utils/helper.js");
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 2:
						...
						return _context.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(false, "no use exist for it"));

					case 5:
						return _context.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(true, "email exists"));
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					...
					case 2:
						...
						return _context2.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(false, "no user exist for it"));

					case 5:
						return _context2.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(true, "username exists"));
			...
			while (1) {
				switch (_context3.prev = _context3.next) {
					...
					case 4:
						...
						return _context3.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(false, "System Error"));
		...
		return babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
			while (1) {
				switch (_context4.prev = _context4.next) {
					...
					case 2:
						_context4.next = 4;
						return _user_model__WEBPACK_IMPORTED_MODULE_4__["User"].findById(id);
					...
					case 4:
						...
						return _context4.abrupt('return', Object(_utils_resuleGenerate__WEBPACK_IMPORTED_MODULE_6__["generateResult"])(false, "System Error"));
